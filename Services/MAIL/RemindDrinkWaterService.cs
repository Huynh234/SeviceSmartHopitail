...
{
    public class RemindDrinkWaterService : BackgroundService
    {
        private readonly IServiceScopeFactory _scopeFactory;

        public RemindDrinkWaterService(IServiceScopeFactory scopeFactory)
        {
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                try
                {
                    using (var scope = _scopeFactory.CreateScope())
                    {
                        ...
                        var reminders = db.RemindDrinkWaters
                        ...
                        foreach (var reminder in reminders)
                        {
                            ...
                            string subject = "Nhắc nhở uống nước định kỳ";
                            string body = reminder.Title ?? "Hãy uống nước hằng ngày để có sức khỏe tốt nhé";
                            ...
                            try
                            {
                                ...
                                db.RemindDrinkWaters.Update(reminder);
                            }
